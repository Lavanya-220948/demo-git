...
$dir = opendir(".");
// FIX: use $entry instead of $file so we do not overwrite the $file variable
...
$oldDir = getcwd();
echo "Current Dir: ".$oldDir."<br>";
chdir("..");
echo "Changed Dir: ".getcwd()."<br>";
chdir($oldDir); // FIX: return to the original directory so future file operations run here
